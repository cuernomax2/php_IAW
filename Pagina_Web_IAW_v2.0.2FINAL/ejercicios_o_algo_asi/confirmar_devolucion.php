...
while($fila_devolto = mysqli_fetch_array($resultado_devolto, MYSQLI_ASSOC)){//En cada iteración do bucle while a cantidade devolta e o modelo varían
...
$query_delete_alugado = "DELETE FROM `vehiculo_devolto`";//Unha vez rematado o while bórrase tóda a táboa vehículo_devolto
