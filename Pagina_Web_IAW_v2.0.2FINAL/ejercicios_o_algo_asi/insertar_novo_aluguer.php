...
<body>
<h1>Nova inserción de alguer</h1>
<form method="post" action="confirmar_insertar_novo_aluguer.php" name="novo_aluguer">
    ...
    <p></p>
    <button type="submit" name="novo_aluguer" value="novo_aluguer">Enviar</button>
</form>
<p>
